...
RouteData routeDataFromJson(dynamic e) {
  return RouteData((e["final_charge"] / 35.0).round(), Duration(seconds: e["walking_duration"].toInt() * 5),
      Duration(seconds: e["driving_duration"].toInt()), (e["cost"] / 70).toInt(), pathFromJson(e["walking_nodes"]),
